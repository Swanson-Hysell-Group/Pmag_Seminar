...
|09/09/16| Read [Essentials Chapter 2: The Geomagnetic Field](https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch1.html) and complete [essentials_ch_2 problem set](). Dig into the guts of: ipmag.igrf, pmag.doigrf and pmag.magsyn. Check IGRF-12 coefficients. Improve documentation.|
|09/16/16| |
